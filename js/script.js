...
document.addEventListener('DOMContentLoaded', function () {
  document.querySelectorAll('.work__btn').forEach(function (e) {
    ...
    e.addEventListener('click', function (e) {
      ...
      document.querySelectorAll('.work__btn').forEach(function (e) {
        e.classList.remove('work__btn_stages')
        document.querySelector(`[data-path='${tabDefault}']`).classList.add('work__btn_stages');
      });
    });
...
const menuBurger = document.querySelector('.header_nav');
